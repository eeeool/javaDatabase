...
public class T04_Images1 {
	...
	private void initialize() {
		...
		lblImg1.setIcon(new ImageIcon(T04_Images1.class.getResource("/t4_windowBuilder/images/amur-tiger-4155922_1280.jpg")));
		lblImg1.setBounds(22, 10, 212, 365);
		pn2.add(lblImg1);

		lblImg2 = new JLabel("New label");
		lblImg2.setIcon(new ImageIcon(T04_Images1.class.getResource("/t4_windowBuilder/images/deer-1367217_1280.jpg")));
		lblImg2.setBounds(256, 10, 212, 365);
		pn2.add(lblImg2);

		lblImg3 = new JLabel("New label");
		lblImg3.setIcon(new ImageIcon(T04_Images1.class.getResource("/t4_windowBuilder/images/pets-3715733_1280.jpg")));
		lblImg3.setBounds(490, 10, 212, 365);
		pn2.add(lblImg3);

		lblImg4 = new JLabel("New label");
		lblImg4.setIcon(new ImageIcon(T04_Images1.class.getResource("/t4_windowBuilder/images/wolf-142173_1280.jpg")));
